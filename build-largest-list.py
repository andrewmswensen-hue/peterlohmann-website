...
<style>
  ...
  .presented-by{{ display:inline-flex; align-items:center; gap:12px; margin:-2px 0 22px;
    font-size:clamp(18px,2.4vw,25px); font-weight:400; color:var(--muted); text-decoration:none; }}
  .presented-by img{{ height:clamp(29px,3.6vw,40px); width:auto; display:block; transform:translateY(1px); }}
